...
const About = () => {
  return (
    <section class="py-10 bg-gray-100 sm:py-16 lg:py-24 invert">
    <div class="max-w-5xl px-4 mx-auto sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-2 md:gap-x-16 lg:gap-x-24 gap-y-10">
            <div>
                <img class="object-cover w-16 h-16 rounded-full invert" src="https://cdn.rareblocks.xyz/collection/celebration/images/cta/9/female-avatar-1.png" alt="" />
                <blockquote>
            ...
            <div>
                <div class="overflow-hidden bg-white">
                    <div class="p-8 lg:px-12 lg:py-10">
                        ...
                        <a href="#" title="" class="invert flex items-center justify-center w-full px-4 py-4 mt-8 text-base font-semibold text-white transition-all duration-200 bg-blue-600 border-2 border-transparent rounded-md hover:bg-blue-700 focus:bg-blue-700" role="button">
